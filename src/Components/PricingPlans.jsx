          ...
          {PLANS_CONTENT.plans.map((plan, index) => (
            <motion.div
              ...
              className={`p-8 rounded-xl shadow-lg bg-neutral-950 ${
                plan.popular
                  ? "border-2 border-blue-900/80"
                  : "border border-neutral-800"
              }`}
            >
              {plan.popular && (
                <div className="text-center mb-4">
                  <span className="text-xs px-3 py-1 rounded-full bg-blue-600 text-white uppercase">
              ...
              <button className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 rounded-lg">
