  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 flex flex-col items-center text-center">
        ...
        <motion.div variants={fadeInUp} className="mt-8 space-x-4">
          <a
            href="#"
          ...
          <a
            href="#"
            className="inline-block border border-gray-5000 hover:border-gray-500 text-white px-4 py-2 rounded-lg font-medium"
          >
        ...
        <motion.div variants={fadeIn} className="mt-12 max-w-7xl">
          <img
            src={heroImage}
            alt="StreamX SaaS Interface"
